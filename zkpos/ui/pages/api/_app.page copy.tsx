...
export default function App() {
  ...
  //       /// muted - something wrong about constructor
  //       // await zkappWorkerClient.initZkappInstance(zkappPublicKey);

  //       console.log('getting zkApp state...');
  //       await zkappWorkerClient.fetchAccount({ publicKey: zkappPublicKey })
        
  //       const treeHeight: any = await zkappWorkerClient.getTreeHeight();
  //       console.log('DEBUG: treeHeight:', treeHeight.toString());
  //       const treeRoot: any = await zkappWorkerClient.getTreeRoot();
  //       console.log('DEBUG: treeRoot:', treeRoot.toString());
  ...
  //   const treeHeight: any = await state.zkappWorkerClient!.getTreeHeight();
  //   console.log('DEBUG: treeHeight:', treeHeight.toString());

  //   setState({ ...state, treeHeight });
  // }
  ...
  //     <div> Current treeHeight in zkApp: { state.treeHeight!.toString() } </div>
  ...
  return (
    <>
    <h1>This is loaded from _app.page.tsx</h1>
    </>
  )
}